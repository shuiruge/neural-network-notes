...
params = fit(init_params, epochs=0, max_step=None)

perturbed_init_params = jax.tree_map(add_noise(1e-3), init_params)
perturbed_params = fit(perturbed_init_params, epochs=0, max_step=None)
